// ==UserScript==
// @name         网页模拟桌面系统 (Web OS) - 终极优化版(apilio) 4.2 Insider
...
function getTheme() {
    ...
    function performSearch(keyword) {
        ...
        if (keyword === 'terminal') { openCTerminal(); searchBox.value = ''; shadow.querySelectorAll('.file-node').forEach(n => n.style.display = 'flex'); return; }
